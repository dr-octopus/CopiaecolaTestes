 ...
 * 
 * @author Java Ranch
 * @see <a href="http://www.coderanch.com/how-to/java/ItextExample">Fonte</a>
 */
public class ItextOutroExemplo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(
			        "src/main/resources/PDFOutput/iTextExample.pdf"));
			...
			HeaderFooter header = new HeaderFooter(new Phrase("This is a header without a page number", new Font(bf_symbol)),
			        false);
